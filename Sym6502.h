...
//	UINT16 pc;
	...
	UINT32 mem_mask;		// maska pami�ci - zale�na od szeroko�ci szyny adresowej,
							// zawiera jedynki w miejscu wa�nych bit�w adres�w
	bool io;
	UINT16 io_from, io_to;

	// funkcje zmieniaj�ce zawarto�� rejestru flagowego
...
public:
	...
	enum IOFunc			// funkcje kolejnych bajt�w z obszaru we/wy symulatora
	{ 
		IO_NONE      = -1,
		TERMINAL_CLS = 0,
		TERMINAL_OUT,
