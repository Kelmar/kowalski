        ...
        for (int i= 0; i < nLength; ++i)
        {
            ...
            if (c < ' ')	// special control char?
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    rgbText = m_rgbInstruction;
                    hFont = m_vbBold[0] ? fntBold : m_hEditorFont;
                    break;
                case 3:
                    rgbText = m_rgbDirective;
                    hFont = m_vbBold[1] ? fntBold : m_hEditorFont;
                    break;
                case 4:
                    rgbText = m_rgbComment;
                    hFont = m_vbBold[2] ? fntBold : m_hEditorFont;
                    break;
                case 5:
                    rgbText = m_rgbNumber;
                    hFont = m_vbBold[3] ? fntBold : m_hEditorFont;
                    break;
                case 6:
                    rgbText = m_rgbString;
                    hFont = m_vbBold[4] ? fntBold : m_hEditorFont;
                    break;
                case 7:
                    rgbBack = m_rgbSelection;
                    break;
                default:
                    ASSERT(false);
                    break;
